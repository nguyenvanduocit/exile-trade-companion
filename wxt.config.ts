...
export default defineConfig({
  ...
  manifest: {
    ...
    host_permissions: ['https://api.liveblocks.io/*', 'wss://api.liveblocks.io/*', 'https://poe.ninja/*', 'https://www.pathofexile.com/*', 'https://pobb.in/*', 'https://browser-intake-datadoghq.com/*'],
    commands: {
